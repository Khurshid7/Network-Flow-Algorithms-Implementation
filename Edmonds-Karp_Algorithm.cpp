...
int main() {
    ...
    // Calculate the maximum flow using the Edmonds-Karp algorithm and measure the runtime
    double runtime = calculateRuntime(edmondsKarp, graph, source, sink);

    // Output the maximum flow and runtime
    cout << "Maximum Flow: " << edmondsKarp(graph, source, sink) << endl;
